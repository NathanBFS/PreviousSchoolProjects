...
public class HeavyTower : MonoBehaviour 
{
	public HeavyShot hOrb = null;
	...
	void Update() 
	{
		...
		if (timeLeft <= 0.0f) 
		{
			...
			{        
				...
				{
					GameObject g = (GameObject)Instantiate(hOrb.gameObject, transform.position, Quaternion.identity);
					
					HeavyShot b = g.GetComponent<HeavyShot>();
